  ...
  const handleSendOrder = () => {
    ...
    try {
      if (contactMethod === "whatsapp") {
        ...
        // Si la ventana no se abrió (bloqueada por el navegador o en escritorio sin app)
        if (!newWindow || newWindow.closed || typeof newWindow.closed === "undefined") {
          // Mostrar mensaje con instrucciones y botón para copiar
          setModalContent({
            title: "Enviar por WhatsApp",
            message: `Por favor envía este mensaje por WhatsApp al número ${WHATSAPP_NUMBER}:`,
            text: orderText,
            contactMethod: "whatsapp",
          })
          setShowModal(true)
        ...
        // Esperar un momento y verificar si se redirigió
        setTimeout(() => {
          // Mostrar mensaje con instrucciones y botón para copiar
          setModalContent({
            title: "Enviar por Email",
            message: `Por favor envía este mensaje por email a ${DEFAULT_EMAIL}:`,
            text: orderText,
            contactMethod: "email",
          })
          setShowModal(true)
      ...
      console.error("Error al abrir la aplicación externa:", error)
      showToast("Hubo un problema al abrir la aplicación. Por favor, intenta manualmente.")
    }
  ...
  return (
    <>
      ...
      <ContactModal
        ...
        contactMethod={modalContent.contactMethod}
        contactInfo={modalContent.contactMethod === "whatsapp" ? WHATSAPP_NUMBER : DEFAULT_EMAIL}
      />
    </>
  )
}
